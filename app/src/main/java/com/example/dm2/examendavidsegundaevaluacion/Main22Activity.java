...
public class Main22Activity extends AppCompatActivity {
    ...
    private String peso;
    private TextView atomico;
    private TextView tsimbolo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        atomico=(TextView)findViewById(R.id.atomico);
        tsimbolo=(TextView)findViewById(R.id.tsimbolo);
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String nombreelem = elemento.getText().toString();
                AsyncPost task = new AsyncPost();
                task.execute(nombreelem);
            }
        });
    ...
    private class AsyncPost extends AsyncTask<String,Void, Void> {
            ...
            try {
                ...
                while(inStream.hasNextLine()) {
                    ...
                    if (result.indexOf("AtomicNumber") > 0)
                        elemen=result.replace("&lt;AtomicNumber&gt;","").replace("&lt;/AtomicNumber&gt;","");
        ...
        protected void onPostExecute (Void result){
            atomico.setText(elemen);
            tsimbolo.setText(simbolo);
            tpeso.setText(peso);
            //Toast.makeText(Main22Activity.this, "Numero atomico:" + elemen + "\nResultado: " + resultado, Toast.LENGTH_LONG).show();
        }
    }
}
